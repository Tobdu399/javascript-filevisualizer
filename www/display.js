...
function updateDisplay() {
	// Update canvas and it's contents every 100ms
	setInterval(function () {
		...
		// filesAmount > 375
		if (width > display.canvas.width - display.canvas.width/4) {
...
// Display the canvas and available directories as soon as HTML body
